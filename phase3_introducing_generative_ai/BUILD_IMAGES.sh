...
# Orchestrator
docker build  -f services/orchestrator_direct/Dockerfile -t localhost:30500/$REGISTRY_FOLDER/orchestrator-direct:$VERSION .
docker push localhost:30500/$REGISTRY_FOLDER/orchestrator-direct:$VERSION
...
# Frontend
docker build --no-cache -f services/frontend/Dockerfile -t localhost:30500/$REGISTRY_FOLDER/frontend_phase3:$VERSION .
docker push localhost:30500/$REGISTRY_FOLDER/frontend_phase3:$VERSION
